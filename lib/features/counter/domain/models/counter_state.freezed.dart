...
mixin _$CounterState {
 ...
 int get count; int get target; String get phrase; bool get isListening;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CounterState&&(identical(other.count, count) || other.count == count)&&(identical(other.target, target) || other.target == target)&&(identical(other.phrase, phrase) || other.phrase == phrase)&&(identical(other.isListening, isListening) || other.isListening == isListening));
}


@override
int get hashCode => Object.hash(runtimeType,count,target,phrase,isListening);

@override
String toString() {
  return 'CounterState(count: $count, target: $target, phrase: $phrase, isListening: $isListening)';
}
...
@useResult
$Res call({
 int count, int target, String phrase, bool isListening
});
...
/// Create a copy of CounterState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? count = null,Object? target = null,Object? phrase = null,Object? isListening = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int count,  int target,  String phrase,  bool isListening)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CounterState() when $default != null:
return $default(_that.count,_that.target,_that.phrase,_that.isListening);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int count,  int target,  String phrase,  bool isListening)  $default,) {final _that = this;
switch (_that) {
case _CounterState():
return $default(_that.count,_that.target,_that.phrase,_that.isListening);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int count,  int target,  String phrase,  bool isListening)?  $default,) {final _that = this;
switch (_that) {
case _CounterState() when $default != null:
return $default(_that.count,_that.target,_that.phrase,_that.isListening);case _:
  return null;
...
@override@JsonKey() final  String phrase;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CounterState&&(identical(other.count, count) || other.count == count)&&(identical(other.target, target) || other.target == target)&&(identical(other.phrase, phrase) || other.phrase == phrase)&&(identical(other.isListening, isListening) || other.isListening == isListening));
}
...
/// Create a copy of CounterState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? count = null,Object? target = null,Object? phrase = null,Object? isListening = null,}) {
